...
class DCGAN(object):
  def __init__(self, sess, input_height=108, input_width=108, crop=True,
         ...
         y_dim=None, z_dim=100, gf_dim=128, df_dim=256,
    ...
    self.g_bn0 = virtual_batch(name='g_bn0')
    self.g_bn1 = virtual_batch(name='g_bn1')
    self.g_bn2 = virtual_batch(name='g_bn2')

    if not self.y_dim:
      self.g_bn3 = virtual_batch(name='g_bn3')
    ...
    if self.dataset_name == 'mnist':
      ...
      print 'Reading images from ' + os.path.join(self.data_dir, self.dataset_name, self.input_fname_pattern)
